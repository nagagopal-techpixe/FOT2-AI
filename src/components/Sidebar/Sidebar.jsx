...
export default function Sidebar({ onClose }) {
  ...
  return (
    // ✅ flex flex-col h-full — sidebar takes full height with fixed bottom
    <div
      className="bg-[#F7F7F7] border-r border-[#00000012] flex flex-col
                  w-[280px] sm:w-[290px] lg:w-[300px]"
      style={{ height: "100dvh" }} // ✅ dvh fixes mobile keyboard issues
    >

      {/* ── Scrollable top content ── */}
      {/* ✅ flex-1 + overflow-y-auto — only this part scrolls */}
      <div className="flex-1 overflow-y-auto px-[18px] pt-[16px] sm:px-[22px] sm:pt-[20px] lg:px-[26px] lg:pt-[24px]">

        {/* Logo row + close btn */}
        <div className="flex items-center justify-between mb-6 sm:mb-7 lg:mb-8 pt-3 lg:pt-4">
          <h1
            className="font-clarendon font-medium text-[18px] sm:text-[20px] lg:text-[21.82px]
                       cursor-pointer leading-[8.82px]"
        ...
        <div className="mb-[14px] sm:mb-[16px] lg:mb-[18px]">
          <div className="flex items-center justify-between mb-[12px] lg:mb-[14px]">
            <div className="flex items-center gap-[8px] lg:gap-[10px]">
              ...
              <span className="font-helvetica font-normal pl-[6px] lg:pl-[8px] text-[12px] sm:text-[13px] lg:text-[14px]">
                Prompt Studio
              </span>
            </div>
            <div className="w-[14.88px] h-[14.88px] flex items-center justify-center border border-black rounded-[4px] font-bold">
          ...
          <div className="pl-[6px] lg:pl-[8px] space-y-[4px]">
            ...
            <div>
              ...
              <p className="font-helvetica font-normal text-[#00000080] text-[10px] sm:text-[11px] lg:text-[12px]">
        ...
        <div className="mb-[14px] sm:mb-[16px] lg:mb-[18px]">
          <div
            className="flex items-center justify-between mb-[12px] lg:mb-[14px] pl-[6px] lg:pl-[8px] cursor-pointer"
          ...
          <div className="pl-[6px] lg:pl-[8px] space-y-[6px] sm:space-y-[7px] lg:space-y-[8px] font-helvetica font-normal text-[11px] sm:text-[12px] lg:text-[12px]">
        ...
        <div className="space-y-[14px] sm:space-y-[16px] lg:space-y-[18px]
                        ...
                        text-[12px] sm:text-[13px] lg:text-[14px]">
          <div className="flex items-center gap-[8px] cursor-pointer" onClick={() => handleNavigate("/app/project")}>
          ...
          <div className="flex items-center gap-[8px] cursor-pointer" onClick={() => handleNavigate("/app/bookmark")}>
      ...
      {/* ── Bottom User Card — ALWAYS VISIBLE, never scrolls away ── */}
      {/* ✅ shrink-0 — this never shrinks, always stays at bottom */}
      <div className="shrink-0 px-[6px] pb-[20px] sm:pb-[22px] lg:pb-[24px] relative">

        {showProfile && <ProfilePopup onClose={() => setShowProfile(false)} />}

        <div onClick={() => setShowProfile(!showProfile)} className="cursor-pointer">
          <div className="px-[16px] sm:px-[20px] lg:px-[26px] pt-[8px]">
            <div
              className="bg-[#0000000D] rounded-[14px]
