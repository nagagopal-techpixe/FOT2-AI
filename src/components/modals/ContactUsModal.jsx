...
const contacts = [
  ...
  {
    label: "Instagram",
    link:" https://instagram.com/fo2.ai",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
  ...
  {
    label: "LinkedIn",
    link:"https://www.linkedin.com/company/fot2",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="white">
...
export default function ContactUsModal({ onClose }) {
  return (
    <div className="fixed inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center z-[9999]
      ...
      <div className="bg-white rounded-[10px]
                      ...
                      flex flex-col overflow-hidden border border-[#00000026]">
        ...
        {/* Contact Items */}
        <div className="px-[14px] py-[12px] space-y-[8px]
  ...
  {contacts.map((item, i) => (
    ...
    >
      ...
      <ChevronRight size={14} className="text-black lg:w-[16px] lg:h-[16px]" />
    </a>
  ))}
