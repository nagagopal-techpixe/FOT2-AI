...
import { Plus, Pencil, Trash2, MoreVertical, Menu } from "lucide-react";
      ...
      <div className="flex flex-col flex-1 h-screen bg-white overflow-hidden">
        ...
        <div className="flex items-center justify-between
          ...
          <button
            ...
            className="flex items-center gap-[6px] sm:gap-[8px]
          ...
          >
            ...
            <span className="font-helvetica font-normal">Create New Project</span>
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto
          ...
          {!loading && projects.length === 0 && (
            <div className="flex flex-col items-center justify-center h-[300px] gap-[12px]">
              ...
              <button
                onClick={() => setShowCreate(true)}
                className="px-[20px] py-[10px] bg-[#FF4400] text-white rounded-[12px] text-[13px] font-helvetica"
              >
              ...
              {projects.map((item) => (
                ...
                >
                  ...
                  <img
                    ...
                    alt="project"
                    className="w-full h-[80px] sm:h-[96px] md:h-[108px] lg:h-[116px] object-cover rounded-[14px]"
                  />
                  ...
                  <div className="p-[8px] sm:p-[10px] lg:p-[12px] relative">
                      ...
                      >
                        ...
                        {openMenu === item._id && (
                          <div className="absolute right-0 top-[26px] lg:top-[28px]
                                          ...
                                          shadow-lg z-20 w-[140px] sm:w-[150px] lg:w-[160px] py-[3px]">
                            <button
                              onClick={() => {
                    ...
                    {item.conversations?.length > 0 && (
                      <p className="text-[10px] sm:text-[11px] font-helvetica text-[#F54900]">
                        {item.conversations.length} {item.conversations.length === 1 ? "chat" : "chats"}
                      </p>
                    )}
                  </div>
                </div>
